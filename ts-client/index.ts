...
import { IgntModule as DtcCreditV_1, msgTypes as DtcCreditV_1MsgTypes } from './dtc.credit.v1'
import { IgntModule as DtcDtcV_1, msgTypes as DtcDtcV_1MsgTypes } from './dtc.dtc.v1'
import { IgntModule as DtcIdentityV_1, msgTypes as DtcIdentityV_1MsgTypes } from './dtc.identity.v1'
import { IgntModule as DtcTaskV_1, msgTypes as DtcTaskV_1MsgTypes } from './dtc.task.v1'
...
const Client = IgniteClient.plugin([
    DtcCreditV_1, DtcDtcV_1, DtcIdentityV_1, DtcTaskV_1, IbcApplicationsInterchainAccountsControllerV_1, IbcApplicationsInterchainAccountsHostV_1, IbcApplicationsTransferV_1, IbcCoreChannelV_1, IbcCoreChannelV_2, IbcCoreClientV_1, IbcCoreClientV_2, IbcCoreConnectionV_1, CosmosNftV_1Beta_1, CosmosEvidenceV_1Beta_1, CosmosFeegrantV_1Beta_1, CosmosCircuitV_1, CosmosUpgradeV_1Beta_1, CosmosAuthV_1Beta_1, CosmosAuthzV_1Beta_1, CosmosBankV_1Beta_1, CosmosBaseNodeV_1Beta_1, CosmosBaseTendermintV_1Beta_1, CosmosConsensusV_1, CosmosDistributionV_1Beta_1, CosmosEpochsV_1Beta_1, CosmosGovV_1, CosmosGovV_1Beta_1, CosmosGroupV_1, CosmosMintV_1Beta_1, CosmosParamsV_1Beta_1, CosmosSlashingV_1Beta_1, CosmosStakingV_1Beta_1, CosmosTxV_1Beta_1, CosmosVestingV_1Beta_1
]);

const registry = new Registry([
  ...DtcCreditV_1MsgTypes,
  ...DtcDtcV_1MsgTypes,
  ...DtcIdentityV_1MsgTypes,
  ...DtcTaskV_1MsgTypes,
