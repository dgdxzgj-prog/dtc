...
import { QueryParamsResponse } from "./types/dtc/task/v1/query";
import { QueryGetClaimRecordResponse } from "./types/dtc/task/v1/query";
import { QueryAllClaimRecordResponse } from "./types/dtc/task/v1/query";

import { QueryParamsRequest } from "./types/dtc/task/v1/query";
import { QueryGetClaimRecordRequest } from "./types/dtc/task/v1/query";
import { QueryAllClaimRecordRequest } from "./types/dtc/task/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/dtc/task/v1/params
   */
  queryParams = (
   ...
   *
   * @tags Query
   * @name queryGetClaimRecord
   * @request GET:/dtc/task/v1/claim_record/{claim_hash}
   */
  queryGetClaimRecord = (claim_hash: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryGetClaimRecordResponse>>>({
      path: `/dtc/task/v1/claim_record/${claim_hash}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  /**
   * QueryListClaimRecord
   *
   * @tags Query
   * @name queryListClaimRecord
   * @request GET:/dtc/task/v1/claim_record
   */
  queryListClaimRecord = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllClaimRecordRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllClaimRecordResponse>>>({
      path: `/dtc/task/v1/claim_record`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
